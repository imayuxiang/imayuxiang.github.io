...
unity_builtin = ["_Time", "_LightColor0", "_Object2World", "unity_LightmapST", "unity_Lightmap"]
...
if __name__ == '__main__':
	(vs_variables, vs_in_variables, vs_out_variables, vs_codes, vs_defines) = parse("water.vsh", True)
	(fs_variables, fs_in_variables, fs_out_variables, fs_codes, fs_defines) = parse("water.fsh", False)
	...
	output_shader("water", vertOut, variables, vs_codes, fs_codes, vs_defines+fs_defines)