...
![input]({{ site.img_url }}/meanshift_input.png)

效果图(左侧为滤波结果，右侧为随机着色)：

![output]({{ site.img_url }}/meanshift_result.png)
